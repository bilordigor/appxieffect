...
const Registration = inject('store')(observer(({ store }) => {
    ...
    const clickRegistartionButton = () => {
        ...
        if (!errorUsername && !errorPasswordLength && !errorSymbols && !errorEmail) {
            store.postData(`${store.url}/reg/`, { "email": email, "password": Crypto.SHA384(password).toString(), "username": username }) 
                .then((data) => {
                    console.log(data)
                    if (data != undefined) {
                        if (data.a) { //true
                    ...
                    <Grid className={classes.gridUnderPaper} item container direction="column" alignItems="center">
                        <Paper variant="outlined" className={classes.Paper}>
                            <Grid container direction="column" justify="center" alignItems="center" className={classes.gridPaper}>
                                ...
                                {errorUsername && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridForgotPassword}>
                                ...
                                {errorEmail && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridForgotPassword}>
                                    <Typography className={classes.ErrorLabel}> Некорректный адрес почты </Typography>
                                </Grid>}
                                {emailAlreadyUsed && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridForgotPassword}>
                                ...
                                <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridForgotPassword}>
                                ...
                                {errorPasswordLength && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridForgotPassword}>
                                    <Typography className={classes.ErrorLabel}> Недопустим пароль менее 6 символов </Typography>
                                </Grid>}
                                {errorSymbols && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridForgotPassword}>
                                    <Typography className={classes.ErrorLabel}> Недопустимые символы в пароле </Typography>
                                </Grid>}
                                {errorServer && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridForgotPassword}>
                                ...
                                <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridForgotRegistration}>
