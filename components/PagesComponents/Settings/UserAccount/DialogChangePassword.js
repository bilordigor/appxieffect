...
const DialogChangePassword = inject('store')(observer(({ openPasswordChangeDialog, setOpenPasswordChangeDialog, store }) => {
        ...
        <Dialog open={openPasswordChangeDialog} onClose={() => setOpenPasswordChangeDialog(false)} aria-labelledby="form-dialog-title">
            ...
            <DialogContent className={classes.dialogContent}>
                ...
                >
                    ...
                    {lengthError && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridErrorLabel}>
                        <Typography className={classes.ErrorLabel}> Недопустим пароль менее 6 символов </Typography>
                    </Grid>}
                    {symError && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridErrorLabel}>
                        <Typography className={classes.ErrorLabel}> Недопустимые символы в пароле </Typography>
                    </Grid>}
                    {errorServer && <Grid item container direction="column" justify="center" alignItems="flex-start" className={classes.gridErrorLabel}>
